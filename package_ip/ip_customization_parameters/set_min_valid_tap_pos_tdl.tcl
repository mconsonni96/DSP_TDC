...
set_param_long_range "MIN_VALID_TAP_POS" $MIN_MIN_VALID_TAP_POS $MAX_MIN_VALID_TAP_POS $DEFAULT_MIN_VALID_TAP_POS $enablement $editable $dependency $tooltip $display_name
# ----------------------------------------------
