...
# ---------------------------- VALID_NUMBER_OF_CARRY_CHAINS_INIT ------------------------
proc update_PARAM_VALUE.VALID_NUMBER_OF_CARRY_CHAINS_INIT { PARAM_VALUE.VALID_NUMBER_OF_CARRY_CHAINS_INIT PARAM_VALUE.NUMBER_OF_CARRY_CHAINS PARAM_VALUE.NUMBER_OF_DSP_CHAINS} {
	# Procedure called to update VALID_NUMBER_OF_CARRY_CHAINS_INIT when any of the dependent parameters in the arguments change
	set NUMBER_OF_CARRY_CHAINS ${PARAM_VALUE.NUMBER_OF_CARRY_CHAINS}
	set NUMBER_OF_DSP_CHAINS ${PARAM_VALUE.NUMBER_OF_DSP_CHAINS}
    	set VALID_NUMBER_OF_CARRY_CHAINS_INIT ${PARAM_VALUE.VALID_NUMBER_OF_CARRY_CHAINS_INIT}
    	
    	set values(NUMBER_OF_CARRY_CHAINS) [get_property value $NUMBER_OF_CARRY_CHAINS]
    	set values(NUMBER_OF_DSP_CHAINS) [get_property value $NUMBER_OF_DSP_CHAINS]
    	set values(VALID_NUMBER_OF_CARRY_CHAINS_INIT) [get_property value $VALID_NUMBER_OF_CARRY_CHAINS_INIT]
    	
    	set MIN_VALID_NUMBER_OF_CARRY_CHAINS_INIT 0
    	set MAX_VALID_NUMBER_OF_CARRY_CHAINS_INIT [expr $values(NUMBER_OF_CARRY_CHAINS) + $values(NUMBER_OF_DSP_CHAINS) -1]
    	set_property range  "$MIN_VALID_NUMBER_OF_CARRY_CHAINS_INIT,$MAX_VALID_NUMBER_OF_CARRY_CHAINS_INIT" $VALID_NUMBER_OF_CARRY_CHAINS_INIT
}

proc validate_PARAM_VALUE.VALID_NUMBER_OF_CARRY_CHAINS_INIT { PARAM_VALUE.VALID_NUMBER_OF_CARRY_CHAINS_INIT } {
	# Procedure called to validate VALID_NUMBER_OF_CARRY_CHAINS_INIT
	return true
}

proc update_MODELPARAM_VALUE.VALID_NUMBER_OF_CARRY_CHAINS_INIT { MODELPARAM_VALUE.VALID_NUMBER_OF_CARRY_CHAINS_INIT PARAM_VALUE.VALID_NUMBER_OF_CARRY_CHAINS_INIT } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.VALID_NUMBER_OF_CARRY_CHAINS_INIT}] ${MODELPARAM_VALUE.VALID_NUMBER_OF_CARRY_CHAINS_INIT}
}
